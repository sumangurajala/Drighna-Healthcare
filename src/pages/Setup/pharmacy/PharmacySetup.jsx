  ...
  const handleSave = () => {
    ...
    if (trimmedCategory) {
      if (editIndex !== null) {
        ...
        updatedData[editIndex] = trimmedCategory;
        setData(updatedData);
      } else {
        // Add new category
    ...
    <Grid container>
      ...
      >
        ...
        <Button
          ...
          color="primary"
          sx={{ mb: 2 }}
          onClick={() => navigate("/setup/pharmacy")}
        >
          Medicine Category
        </Button>
        <Button
        ...
        <Button
          ...
          color="primary"
          sx={{ mb: 2 }}
          onClick={() => navigate("/setup/medicinedoasagelist")}
        >
          Medicine Dosage
        </Button>
        <Button
          ...
          color="primary"
          sx={{ mb: 2 }}
          onClick={() => navigate("/setup/doasagelist")}
        >
          Dose Interval
        </Button>
        <Button
          ...
          color="primary"
          sx={{ mb: 2 }}
          onClick={() => navigate("/setup/doasagedurationlist")}
        >
          Dose Duration
        </Button>
      </Grid>
